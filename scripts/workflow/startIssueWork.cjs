...
function usage() {
  return `Usage:
  node scripts/workflow/startIssueWork.cjs --title "Issue title" [--body "text"] [--body-file path] [--label name]
  node scripts/workflow/startIssueWork.cjs --issue 123 [--branch issue-123-name]
