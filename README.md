...
- **Catalog-aware completions, hover cards, and signature help**: backed by the bundled PangoScript command catalog, Object Tree property data, tracked OSC control route links, and current-file `Goto` label suggestions. Hovers show syntax form, parameters, safety tier, and a primary example.
