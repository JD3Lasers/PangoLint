...
describe("checked-in Object Tree data layout migration", () => {
  ...
  it("keeps shipped public artifacts free of private lab identifiers", () => {
    const artifacts = [
      ...
      "data/pangoscript/object-tree/evidence/value/issue-149-geometry-boundary-probes.json",
      "data/pangoscript/object-tree/evidence/value/issue-149-fb4-geometry-boundary-probes.json",
      "data/pangoscript/object-tree/evidence/value/issue-151-universe-coloroff-visual-write.json",
