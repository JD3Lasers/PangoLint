...
4. Read runtime tools (\`healthCheck\`, \`readBeyondProperty\`) require PANGOLINT_MCP_RUNTIME_READ=enabled. The legacy PANGOLINT_MCP_RUNTIME=enabled flag enables read tools only.
...
6. \`runScript\` lints before sending and refuses on error-severity diagnostics. Hint/warning diagnostics surface in the response but do not block. Relay them to the user.
