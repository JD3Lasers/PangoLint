...
4. Read runtime tools (\`healthCheck\`, \`checkTalkConnection\`, \`readBeyondProperty\`) require PANGOLINT_MCP_RUNTIME_READ=enabled. The legacy PANGOLINT_MCP_RUNTIME=enabled flag enables read tools only.
