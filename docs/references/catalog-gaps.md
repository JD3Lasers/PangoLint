# PangoLint catalog gap report

Generated: 2026-05-09T01:28:33.325Z
Catalog: 529 commands
Corpus: 63 files, 390 command uses
...
| Gap | Total commands | …of which used in corpus |
| --- | --- | --- |
| Empty description | 0 | 0 |
| Missing parameters (signature implies args) | 0 | 0 |
| Terse description (1-39 chars, non-empty) | 0 | 0 |
| Safety tier = unknown | 0 | 0 |
